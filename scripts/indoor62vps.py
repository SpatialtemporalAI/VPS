...
###原始pose是w2c的  需求逆
# ============ 配置路径 ============
source_dir = Path("/home/phw/newdisk1/VPS_data/indoor6/scene6/images")
ref_split = Path("/home/phw/newdisk1/VPS_data/indoor6/scene6/scene6_train.txt")
test_split = Path("/home/phw/newdisk1/VPS_data/indoor6/scene6/scene6_test.txt")

ref_image_dir = Path("datascene6/ref/rgb") 
ref_pose_dir = Path("datascene6/ref/poses")   
query_image_dir = Path("datascene6/query/rgb")
query_pose_dir = Path("datascene6/query/poses")
ref_calibration_dir = Path("datascene6/ref/calibration")
query_calibration_dir = Path("datascene6/query/calibration")
